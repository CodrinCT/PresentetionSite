    ...
    return (
      ...
      <div className={style.overlayDiv}>
          <div className={style.info}>
              ...
              <h2>Obiectivul activitatii</h2> 
              <p style={{color:'black'}}>Secretul succesului este echilibrul dintre a te bucura de ceea ce faci și a-ți asuma responsabilitatea de a o face în modul cel mai priceput. Dezvoltatorii noștri răspund adesea la e-mailurile de afaceri după programul de lucru, pentru a ne asigura că platforma dvs. software este cât se poate de bună. Ei fac acest lucru din pasiune și nu am putea fi mai mândri de dorința și dedicarea lor.</p>
              </div>
